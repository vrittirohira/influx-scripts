def process_scheduled_call(influxdb3_local, call_time, args=None):
      ...
      SELECT
        ...
        CASE WHEN SUM(io_count) > 0 THEN SUM(io_byte_count) / SUM(io_count) ELSE 0 END AS avg_io_size,
        CASE WHEN COUNT(*) > 0 THEN SUM(io_count) / (60.0 * COUNT(*)) ELSE 0 END AS avg_iops,
